...
class BEDSR(nn.Module):
    ...
    def __init__(self, num_in_ch=3, num_out_ch=3, num_feat=64, num_block=16, upscale=4, img_range=1., rgb_mean=(0.4488, 0.4371, 0.4040)):
      ...
      self.conv_after_body = BinaryConv2d(num_feat, num_feat, 3, 1, 1)
      ...
      # initialization
      default_init_weights([self.conv_first, self.upconv, self.conv_hr, self.conv_last], 0.1)
